...
<div class="content last">
	<div class="grid_1 col1">
		...
		<h2><div class="thin_rule"><a href="<?=bloginfo('url')?>/about/#lists"><span>Subscribe</span></a><br><span class="caption">Subscribe to our mailing lists</span></div></h2>
		...
		<h2><div class="thin_rule"><a href="<?=bloginfo('url')?>/events"><span>Events Calendar</span></a><br><span class="caption">Openings, actions, screenings</span></div></h2>

		<h2><div class="thin_rule"><a href="links.htm"><span>Counter Cartography Links</span><br><span class="caption">Spaces, artist groups, collectives, network</span></div></h2>

	</div>

	<div class="grid_1 col"><!-- dont touch -->
...
-->
	...
	<div class="grid_1 col">
		...
		<h3><div class="thin_rule"><a href="/everything/">Welcome to the New Paradigm or 
Crisis of Everything Everywhere</a><br><span class="subtitle">Jan. 7-15, 2012</span></div></h3>
