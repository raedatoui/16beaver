...
<div class="<?php echo  $klass2 ?> col" id="sidebar">
  <div id="barcontent">
    ...
    <div class="sharing">
      <ul class="archives"><ul>
        <li class="flexo-month-link">
          ...
          <ul class="flexo-list">
            <li><a target="_blank" href="http://twitter.com/home/?status=<?php the_title();?> - <?php echo wp_get_shortlink();?>">Twitter</a></li>
            <li><a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?> - <?php echo wp_get_shortlink();?> ">Facebook</a></li>
            <li><a target="_blank" href="https://plus.google.com/share?url=<?php the_permalink(); ?>"onclick="javascript:window.open(this.href,
    ...
    <a class="scmPinterest" href="http://pinterest.com/pin/create/button/?url=<?php the_permalink();?> - <?php echo wp_get_shortlink();?>">Pinterest</a>
    </div> -->
